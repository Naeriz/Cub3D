...
BONUS_EXEC	=	$(BONUSEXECDIR)/meth_bonus.c $(BONUSEXECDIR)/mover_bonus.c $(BONUSEXECDIR)/textures_bonus.c $(BONUSEXECDIR)/normi_dump_bonus.c $(BONUSEXECDIR)/inits_bonus.c $(BONUSEXECDIR)/mlx_draw_bonus.c $(BONUSEXECDIR)/minimap_bonus.c $(BONUSEXECDIR)/rotator_bonus.c $(BONUSEXECDIR)/animated_bonus.c $(BONUSEXECDIR)/door_bonus.c $(BONUSEXECDIR)/oia_bonus.c
