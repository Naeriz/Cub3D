...
#    Updated: 2026/01/04 18:20:26 by sionow           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
BONUS_EXEC	=	$(EXECDIR)/meth.c $(EXECDIR)/mover.c $(EXECDIR)/textures.c $(EXECDIR)/normi_dump.c $(BONUSEXECDIR)/inits_bonus.c $(BONUSEXECDIR)/mlx_draw_bonus.c $(BONUSEXECDIR)/minimap_bonus.c $(BONUSEXECDIR)/rotator_bonus.c
